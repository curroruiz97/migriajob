...
/**
 * Configuración de la cuenta para empleadores.
 * Misma estructura y secciones que /dashboard/configuracion (candidatos):
 *   - Email de la cuenta
 *   - Contraseña
 *   - Notificaciones
 *   - Cuenta y privacidad (exportar JSON, eliminar cuenta)
 *
 * El componente <DangerZone /> se reutiliza porque actúa sobre el usuario
 * actualmente logueado y no distingue rol.
 */
